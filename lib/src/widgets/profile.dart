...
class Profile extends StatelessWidget{
  ...
  return StreamBuilder<Vendor>(
    ...
    builder: (context, snapshot) {
      return Column(
        children: [
          Expanded(child: (snapshot.data != null) 
          ? ListView(children: [
              Padding(
                ...
                child: Row(
                  ...
                  children: [
                    Flexible(
                      flex: 2,
                      child: ClipRRect(child: Image.network(snapshot.data.imageUrl),
          ...
          : Center(child: AppButton(buttonText: 'Create a Vendor Profile',
          buttonType: ButtonType.LightBlue, 
          ...
          CupertinoButton(
            child: Text('Click here to Logout', style: TextStyle(color: AppColors.straw, fontSize: 18.0)), 
