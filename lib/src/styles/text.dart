...
abstract class TextStyles{
  static TextStyle get title{
    return GoogleFonts.poppins(
      textStyle: TextStyle(color: AppColors.darkblue, fontWeight: FontWeight.bold, fontSize: 40.0));
  }
  static TextStyle get subTitle{
    return GoogleFonts.economica(
      textStyle: TextStyle(color: AppColors.straw, fontWeight: FontWeight.bold, fontSize: 30.0));
  }
  static TextStyle get listTitle{
    return GoogleFonts.economica(
      textStyle: TextStyle(color: AppColors.straw, fontWeight: FontWeight.bold, fontSize: 25.0));
  }
  ...
  static TextStyle get link{
   ...
   static TextStyle get suggestion{
     return GoogleFonts.roboto(
      textStyle: TextStyle(color: AppColors.lightgray, fontSize: 15.0));
   }
