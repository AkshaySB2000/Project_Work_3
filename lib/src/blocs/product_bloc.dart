...
class ProductBloc {
  ...
  //Get
  Stream<String> get productName => _productName.transform(validateProductName);
  ...
  Stream<List<Product>> productByVendorId(String vendorId) => db.fetchProductByVendorId(vendorId);
  ...
  pickImage() async {
    ...
    if (permissionStatus.isGranted) {
      ...
      if (image != null) {
        ...
        var imageUrl = await storageService.uploadProductImage(compressedFile, uuid.v4());
